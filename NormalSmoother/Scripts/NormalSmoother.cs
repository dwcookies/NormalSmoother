...
public class NormalSmoother : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        if (GUILayout.Button("平滑法线预览")) PreviewSmoothNormal();
        GUILayout.Space(50);
    ...
    private void PreviewSmoothNormal()
    {
        ...
        //平滑物体法线到顶点色
        NormalSmootherUtility.AverageObjectNormalsToMeshColors(obj);
    ...
    private void ExportSmoothNormalMesh()
    {
        ...
        dstPath += "CK_NormalSmoothed_" + Path.GetFileName(srcPath);
...
public static class NormalSmootherUtility
{
    ...
    public static Color[] AverageMeshNormalsToMeshColors(Mesh mesh)
    {
        ...
        for (int i = 0; i < mesh.vertexCount; i++)
        {
            ...
            averageNormal = TBN.MultiplyVector(averageNormal).normalized;
    ...
    public static Color[] AverageMeshNormalsToMeshColorsByJob(Mesh mesh)
    {
        ...
        NativeArray<Color> colors = new NativeArray<Color>(mesh.colors, Allocator.Persistent);
    ...
    public struct ComputeSmoothedNormalJob : IJobParallelFor
    {
        ...
        public void Execute(int index)
        {
            ...
            Matrix4x4 TBN = new Matrix4x4(tangent, bitangent, normal, Vector3.zero);
            smoothedNormal = TBN.MultiplyVector(smoothedNormal).normalized;
